---
title: "LLMs and ADHD: A Genuine Help or a Gilded Crutch?"
date: 2026-03-08
excerpt: "366 million adults live with ADHD — and they're 55% more likely than neurotypical peers to use AI at work. The gains are real. So are the risks beneath them."
author: "Nitin Mohan"
coverImage: "https://images.pexels.com/photos/14386896/pexels-photo-14386896.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
...
A 2025 arXiv study analysed 55,114 Reddit posts across 27 neurodivergent subreddits and found that ADHD users directed 26.33% of all LLM-related discussions toward productivity and professional development — the highest proportion of any neurodivergent group studied ([arXiv](https://arxiv.org/html/2410.06336v1)). The top use cases: information synthesis (62.5% of users), task prioritisation (31.7%), and organising thoughts (25.3%).
...
A 2024 EY study of 300+ neurodivergent employees using Microsoft Copilot found that 85% said generative AI supports a more inclusive workplace, and 88% reported increased productivity ([EY](https://www.ey.com/en_uk/newsroom/2024/12/study-highlights-benefits-of-copilot)). These aren't marginal returns.
...
Here's where the picture gets harder to look at squarely. A January 2025 study of 666 participants found a statistically significant *negative* correlation between frequent AI tool usage and critical thinking ability, mediated by cognitive offloading ([Gerlich, MDPI *Societies*](https://www.mdpi.com/2075-4698/15/1/6)). Younger and heavier users showed the strongest dependence and the lowest critical thinking scores.
...
A 2024 Delphi study with ten ADHD clinical experts scored ChatGPT 4.8/5 for engagement — and 0/5 for responsiveness to nonverbal cues ([PMC](https://pmc.ncbi.nlm.nih.gov/articles/PMC10970191/)). That gap defines exactly where the tool ends and the human begins.
...
"Crutch" implies something that prevents recovery — a misleading frame. Glasses don't weaken vision; they enable function. For the 89% of people with ADHD who have at least one executive function impairment ([PMC](https://pmc.ncbi.nlm.nih.gov/articles/PMC11485171/), 2024), LLMs are more prosthetic than crutch. The risk isn't the tool itself — it's using it without awareness of the cognitive dependency it can quietly build.

### Can LLMs replace ADHD therapy or medication?

No. ChatGPT scored 0/5 on nonverbal cue responsiveness in a 2024 expert panel evaluation ([PMC](https://pmc.ncbi.nlm.nih.gov/articles/PMC10970191/)). The tools are useful for day-to-day task scaffolding, not clinical intervention. They work alongside treatment — not instead of it.
...
If you have a specific question about ADHD, LLMs, or language model applications, the [semantic FAQ](/ask) on this site answers in plain language. And if you're curious how language models handle real-world complexity at production scale, the post on [building multilingual semantic search](/blog/multilingual-semantic-search) covers exactly that.
